...
def test_anti_alias_activation():
    ...
    fused_anti_alias_activation = activation1d.Activation1d(activation=SnakeBeta(10), fused=True).xpu()
    fused_activation_output = fused_anti_alias_activation(data)

    torch_anti_alias_activation = activation1d.Activation1d(activation=SnakeBeta(10), fused=False).xpu()
